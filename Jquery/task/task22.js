    ...
    var App = {
      init: function() {
       ...
       // this.todoTemplate = Handlebars.compile($('#todo-template').html());
        this.footerTemplate = Handlebars.compile(document.querySelactor
      ...
      bindEvents: function() {
       // $('.new-todo').on('keyup', this.create.bind(this));
        ...
        //   todoList.addEventListener('dblclick', 'label', this.editingMode.bind(this))
        //   todoList.addEventListener('keyup', '.edit', this.editKeyup.bind(this))
        //   todoList.addEventListener('focusout', '.edit', this.update.bind(this))
        //   todoList.addEventListener('click', '.destroy', this.destroy.bind(this));
      },
      render: function() {
